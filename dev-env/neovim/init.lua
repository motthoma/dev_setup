...
-- Basic smart auto-indent for programming languages (C-style)
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- 1. Mason setup (core manager)
      require('mason').setup()

      -- 2. Mason Tool Installer setup
      -- This ensures all your LSPs, linters, and formatters are installed automatically
      require('mason').setup()
      ...
      require('mason-tool-installer').setup {
        ...
        auto_update = true, -- optional: keep tools up-to-date
        run_on_start = true, -- automatically installs missing tools when Neovim starts
      }

      -- 3. Mason LSPconfig setup
      -- Only installs the LSPs you explicitly listed
      local servers = {
        pyright = {},
        clangd = {},
      } -- you can customize per-server settings here

      local capabilities = vim.lsp.protocol.make_client_capabilities()
      require('mason-lspconfig').setup {
        ensure_installed = { 'pyright' },
        automatic_installation = false, -- rely on mason-tool-installer
        handlers = {
